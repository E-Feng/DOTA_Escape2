...
function _ScoreboardUpdater_UpdatePlayerPanel( scoreboardConfig, playersContainer, playerId, localPlayerTeamId )
{
	...
	if ( playerInfo )
	{
		...
		_ScoreboardUpdater_SetTextSafe( playerPanel, "DeathCounter", playerInfo.player_deaths );
		...
		if ( playerColorBar !== null )
		{
			if ( GameUI.CustomUIConfig().team_colors )
			{
				...
				var teamColor = GameUI.CustomUIConfig().team_colors_copy[ playerId ];
				if ( teamColor )
				{
...
//		$.Msg( "UpdateTeamPanel.Create: ", teamPanelName, " = ", scoreboardConfig.teamXmlName );
	...
	if ( playersContainer )
	{
		for ( var playerId of teamPlayers )
		{
			...
			var playerInfo = Game.GetPlayerInfo( playerId );
			totalDeaths = totalDeaths + playerInfo.player_deaths;
		}
	}
	...
	_ScoreboardUpdater_SetTextSafe( teamPanel, "TeamScore", totalDeaths )
